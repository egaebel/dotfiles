# Uncomment for profiling, see similar command at the bottom.
# zmodload zsh/zprof
...
# Set my zsh option overrides: http://zsh.sourceforge.net/Doc/Release/Options.html
...
# Uncomment for profiling, see similar command at the top.
# zprof
